...
| File | Size | Download |
|------|------|----------|
| `slipnet-windows-amd64.exe` | 11.1 MB | [⬇️ Download](https://raw.githubusercontent.com/leohaghighi/LatestReleaseMirror/main/releases/anonvector/SlipNet/slipnet-windows-amd64.exe) |
<!-- RELEASES_END -->
